<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="GiaHan.aspx.cs" Inherits="QuanLy.CamDo.GiaHan" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="Content">
                ...
                <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="3" DataSourceID="SqlDataSourceThongTinDoCam" OnDataBound="ASPxFormLayout1_DataBound">
                    <Items>
                        ...
                        <dx:LayoutItem Caption="">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxTextBox ID="ASPxFormLayout1_E1" runat="server" Font-Size="Large" ReadOnly="True" Text="Gia Hạn" Width="170px" Enabled="False" HorizontalAlign="Right">
                        ...
                        <dx:LayoutItem Caption="">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxDateEdit ID="dateNgayChuoc" runat="server" Caption="Ngày Gia Hạn" DisplayFormatString="dd/MM/yyyy" EditFormat="Custom" EditFormatString="dd/MM/yyyy" Font-Size="Large" HorizontalAlign="Right">
	...
	cp.PerformCallback();
                        ...
                        <dx:LayoutItem Caption="">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxSpinEdit ID="seSoNgayCam" runat="server" Caption="Số Ngày Cầm" DisplayFormatString="N0" Font-Size="Large" Number="0" ReadOnly="True" HorizontalAlign="Right" Enabled="False">
                                        <SpinButtons ShowIncrementButtons="False">
                                        </SpinButtons>
                                        <CaptionSettings VerticalAlign="Middle" />
